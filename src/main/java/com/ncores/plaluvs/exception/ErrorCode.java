...
public enum ErrorCode {
    ...
    SKIN_TYPE_NOT_FOUND(HttpStatus.FORBIDDEN, "금일 진행한 스킨타입이 없습니다. 설문조사를 해주세요"), SKIN_WORRY_EMPTY(HttpStatus.FORBIDDEN, "피부 걱정 설문조사를 해주세요"), CATEGORY_NOT_FOUND(HttpStatus.FORBIDDEN, "해당하는 카테고리가 없습니다." ),
